...
(function($)
{
	$(document).ready(function()
	{
		...
		$list_action.find('#submit').click(function(){ //tim toi the co id = submit,su kien click
			...
			//ajax để xóa
			$.ajax({
				url:'http://localhost/www/CodeIgniter/admin/product/deleteAll',
				type: 'POST',
				data : {'ids': ids},
				success: function()
				{
		...
		$list_action.find('#submit').click(function(){ //tim toi the co id = submit,su kien click
			...
			//ajax để xóa POST
			$.ajax({
				url:'http://localhost/www/CodeIgniter/admin/catalog/deleteAll',
				type: 'POST',
				data : {'ids': ids},
				success: function()
				{
		...
		$list_action.find('#submit').click(function(){ //tim toi the co id = submit,su kien click
			...
			//ajax để xóa POST
			$.ajax({
				url:'http://localhost/www/CodeIgniter/admin/news/deleteAll',
				type: 'POST',
				data : {'ids': ids},
				success: function()
				{
